...
///number seats
////generate coordinates by click//////

const generatedNumberRange = (from, to) => {
  const result = [];
...
const getSectorLines = () => {
  ...
  return generatedNumberRange(1, 10)
    .map(
      lineNumber =>
...
const renderArena = () => {
  ...
  const sectorString = generatedNumberRange(1, 3)
    .map(
      sectorNumber =>
