...
import { upadateTask, getTasksList } from './tasksGateway.js';
...
export const toggleTask = event => {
  ...
  const { text, createDate } = tasksList.find(task => task.id === taskId); // присваиваем значение свойства localStorage.tasksList в переменную
